    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content br_15px-s">
            ...
            <div class="w-100 d-flex justify-content-around border-top-0 mt-5 mb-4">
                <a href="" class="w-25 font_20px-s font-weight-bold no_link-s shadow text-center button_outline-s text-white border-0 bg-primary-s py-3 br_50px-s " role="button" id="add_product"> Save</a>
            </div>
        </div>
    </div>
</div>
